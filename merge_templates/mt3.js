...
function mt3Carousel() {
    // let $ = jQuery;
    // let items = $(`.bi-item`);
    // let count = items.length;
    // let navigator = $(`.bi-navigator`);
    // let left = $(`.bi-col:nth-child(1) img`);
    // let right = $(`.bi-col:nth-child(3) img`);
    // for (let i = 0; i < (count > 5 ? 5 : count); i++) {
    //     let item = items.eq(i);
    //     if (item == undefined) {
    //         break;
    //     }
    //     item.toggleClass(`active-item`);
    // }
    // for (let i = 0; i < count; i++) {
    //     navigator.append(`<div class="bi-dot"></div>`);
    // }
    ...
    //         if (end) return;
    //         let current = $(this);
    //         if (current.hasClass(`active-item`)) {
    //             let ind = current.index();
    //             current.toggleClass(`active-item`);
    //             items.eq(ind + 5).toggleClass(`active-item`);
    //             end = true;
    //             // for (let i = ind + 1; i < 5 + ind; i++) {
    //             //     items.eq(i + 1).
    //             // }
    //         }
    //     });
